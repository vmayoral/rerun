...
namespace rerun {
    ...
    Result<std::vector<DataCell>> AsComponents<archetypes::Ellipsoids>::serialize(
        const archetypes::Ellipsoids& archetype
    ) {
        ...
        {
            auto indicator = Ellipsoids::IndicatorComponent();
